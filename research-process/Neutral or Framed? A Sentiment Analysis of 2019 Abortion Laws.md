...
**Methods:** We identified a sample of 2019 abortion bills using the legislative tracking tool Legiscan and included those that met specified criteria (N = 19 bills). We categorized each bill as restrictive (n = 12) or protective (n = 7). We ran aggregate (i.e., all bills) and separate (protective × restrictive) SA, generating scores that we interpreted qualitatively (higher scores indicated predominance of positive wording).
